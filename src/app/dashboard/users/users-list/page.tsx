            ...
            <tbody>
              {users.map((user) => (
                <tr key={user.id} className="border-t hover:bg-gray-50">
                  <td className="py-4 text-gray-800 px-4">{user.name}</td>
                  <td className="py-4 text-gray-800 px-4">{user.email}</td>
                  <td className="py-4 text-gray-800 px-4">{user.role}</td>
                  <td className="py-4 text-gray-800 px-4">
                    <span
                      className={`${
                        user.status === "Active"
                          ? "text-green-500"
